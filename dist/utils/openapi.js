...
function buildParamSchema(paramName) {
    return {
        name: paramName,
        in: 'query',
        required: false,
        ...
        spec['requestBody'] = {
            content: {
                'application/json': {
                    schema: {
                        type: 'object',
                        properties: Object.fromEntries((route.params ?? []).map((p) => [p, { type: 'string' }])),
                    },
                },
            },
        };
...
function generateOpenApiSpec(config, version = '1.0.0') {
